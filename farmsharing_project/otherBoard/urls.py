...
#사례 게시판
    ...
    path('review/new_comment/<int:review_id>',views.review_new_comment, name = 'review_new_comment'),
    path('review/delete_comment/<int:comment_id>',views.review_delete_comment, name = 'review_delete_comment'),
